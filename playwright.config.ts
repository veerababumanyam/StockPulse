...
export default defineConfig({
  ...
  projects: [
    ...
    // Authentication tests (no dependencies, run fresh)
    {
      ...
      testDir: './tests/auth',
      testMatch: /auth-context\.test\.tsx|login-component\.test\.tsx|debug-auth\.test\.tsx/,
  ...
  webServer: [
    ...
    {
      command: 'cd services/backend && python -m uvicorn app.main:app --host 0.0.0.0 --port 8000 --reload',
      port: 8000,
      reuseExistingServer: !process.env.CI,
      timeout: 120000,
    }
