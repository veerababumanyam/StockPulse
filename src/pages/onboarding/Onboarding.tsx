...
const Onboarding: React.FC = () => {
  ...
  const [tradingExperience, setTradingExperience] = useState<string>('beginner');
  ...
  const goalOptions = [
    { id: 'growth', label: 'Growth', description: 'Focus on capital appreciation' },
    { id: 'income', label: 'Income', description: 'Generate regular income' },
    { id: 'preservation', label: 'Preservation', description: 'Protect existing capital' },
    { id: 'speculation', label: 'Speculation', description: 'High-risk, high-reward opportunities' },
    { id: 'retirement', label: 'Retirement', description: 'Long-term retirement planning' },
  ];
  
  // Theme options
  const themeOptions = [
    { id: 'tropical-jungle', name: 'Tropical Jungle', description: 'Vibrant Greens', primary: '#29A329' },
    { id: 'ocean-sunset', name: 'Ocean Sunset', description: 'Blues + Corals', primary: '#008B8B' },
    { id: 'desert-storm', name: 'Desert Storm', description: 'Warm Neutrals', primary: '#C19A6B' },
    { id: 'berry-fields', name: 'Berry Fields', description: 'Purples + Pinks', primary: '#8E4585' },
    { id: 'arctic-moss', name: 'Arctic Moss', description: 'Cool Grays + Greens', primary: '#4682B4' },
  ];
        ...
        {!completed ? (
          <div className="max-w-2xl mx-auto">
            <div className="mb-8 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-2">
                Let's set up your account to get the most out of your trading experience
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
              ...
              {currentStep === 2 && (
                ...
                >
                  <div>
                    <h2 className="text-xl font-semibold mb-1">Trading Experience</h2>
                    <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              {currentStep === 3 && (
                ...
                >
                  <div>
                    <h2 className="text-xl font-semibold mb-1">Investment Goals</h2>
                    <p className="text-gray-600 dark:text-gray-400 mb-4">
                      Select your primary investment objectives (select all that apply)
                    </p>
                  </div>
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">
                    <p>Selected goals: {investmentGoals.length} of {goalOptions.length}</p>
                  </div>
                </motion.div>
              )}
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            Prefer stability and minimal risk, willing to accept lower returns
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            Balanced approach with some risk for potential higher returns
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            Comfortable with significant risk for potentially higher returns
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            Seeking maximum returns, willing to accept high volatility and potential losses
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="flex justify-between">
              {currentStep === 1 ? (
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium bg-white text-gray-700 border border-gray-300 rounded-md hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700"
                >
                  Previous
                </button>
              )}
          ...
          <div className="max-w-md mx-auto text-center">
            <motion.div
              ...
              className="mb-8"
            >
              <div className="w-20 h-20 bg-primary-100 rounded-full flex items-center justify-center mx-auto dark:bg-primary-900/30">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              Your StockPulse account is ready to use. You'll be redirected to your dashboard in a moment.
            </p>
