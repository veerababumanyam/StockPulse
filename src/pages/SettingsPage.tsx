...
import { Settings, User, Shield, Bell, Moon, Sun, LogOut, HelpCircle, Palette } from 'lucide-react';
        ...
        <div className="w-full md:w-64 flex-shrink-0">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
            ...
            <nav className="space-y-1">
              ...
              <button
                className="w-full flex items-center px-3 py-2 text-sm font-medium rounded-md text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20 transition-colors duration-150"
              >
            ...
            {activeTab === 'appearance' && (
              ...
              >
                ...
                <div className="space-y-8">
                  {/* Theme Mode */}
                  <div>
                    <h4 className="text-md font-medium mb-4">Theme & Colors</h4>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                      Customize the look and feel of StockPulse with your preferred color theme and mode.
                    </p>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                          <h5 className="font-medium mb-2">Current Theme</h5>
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="ml-2 text-sm text-gray-600 dark:text-gray-300">
                              {colorTheme.charAt(0).toUpperCase() + colorTheme.slice(1).replace('-', ' ')}
                            </span>
                          </div>
                        </div>
                        
                        <div className="p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                          <h5 className="font-medium mb-2">Current Mode</h5>
                  ...
                  {/* Layout Preferences */}
                  <div>
                    <h4 className="text-md font-medium mb-4">Layout Preferences</h4>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
