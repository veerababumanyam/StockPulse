...
import { AlertCircle, CheckCircle, Key, Lock, Shield, Eye, EyeOff, Plus, Trash2, RefreshCw } from 'lucide-react';
...
const apiProviders = [
  ...
  { 
    ...
    website: 'https://docs.anthropic.com/claude/reference/getting-started-with-the-api',
    keyFormat: 'sk-ant-...',
    category: 'ai'
  },
  { 
    ...
    <div className="container mx-auto py-6 space-y-8">
      <div className="flex justify-between items-center">
        ...
        <Dialog open={isAddingKey} onOpenChange={setIsAddingKey}>
          ...
          <DialogContent className="sm:max-w-[500px]">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleAddKey)} className="space-y-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        {field.value && apiProviders.find(p => p.id === field.value)?.description}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <Alert variant="warning" className="mt-4">
                  ...
                  <AlertDescription>
                    Your API key will be encrypted before storage and never exposed in the frontend.
                  </AlertDescription>
                </Alert>
                
                <DialogFooter>
                  <Button type="button" variant="outline" onClick={() => setIsAddingKey(false)}>
                    Cancel
                  </Button>
      ...
      <Tabs defaultValue="all" value={activeTab} onValueChange={setActiveTab}>
        <TabsList>
          ...
          <TabsTrigger value="financial">Financial ({apiKeys.filter(key => {
            const provider = apiProviders.find(p => p.id === key.providerId);
            return provider?.category === 'financial';
          }).length})</TabsTrigger>
          <TabsTrigger value="ai">AI Models ({apiKeys.filter(key => {
            const provider = apiProviders.find(p => p.id === key.providerId);
        ...
        <TabsContent value={activeTab} className="mt-6">
          <Card>
                  ...
                  {filteredKeys.length === 0 ? (
                    ...
                    filteredKeys.map(apiKey => (
                      <TableRow key={apiKey.id}>
                        ...
                        <TableCell>{getProviderName(apiKey.providerId)}</TableCell>
                        <TableCell>
            ...
            <CardFooter className="flex justify-between border-t px-6 py-4">
              ...
              <Button variant="outline" size="sm" onClick={() => setIsAddingKey(true)}>
                ...
                <CardContent className="pb-2">
                  ...
                  <div className="mt-2">
                    <Badge variant="outline" className="mt-2">
                      {provider.category === 'financial' ? 'Financial Data' : 'AI Model'}
                    </Badge>
                  </div>
                </CardContent>
          ...
          <ul className="space-y-2">
            <li className="flex items-start gap-2">
              ...
              <span className="text-sm">
                <strong>Regular rotation:</strong> Rotate your API keys every 90 days for enhanced security.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <div className="mt-0.5 text-green-600">
              ...
              <span className="text-sm">
                <strong>Least privilege:</strong> Use keys with the minimum required permissions for your use case.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <div className="mt-0.5 text-green-600">
              ...
              <span className="text-sm">
                <strong>Monitoring:</strong> Regularly review API key usage for unusual patterns.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <div className="mt-0.5 text-green-600">
              ...
              <span className="text-sm">
                <strong>Immediate revocation:</strong> Revoke keys immediately if they are compromised.
              </span>
            </li>
          </ul>
        </CardContent>
