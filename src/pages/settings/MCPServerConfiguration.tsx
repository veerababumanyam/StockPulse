    ...
    const interval = setInterval(() => {
      ...
      setServerMetrics((prev) => ({
        ...
        activeConnections: Math.min(
          prev.activeConnections + (Math.random() > 0.7 ? 1 : 0),
  ...
  const registerWithFederation = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description:
          "StockPulse MCP Server has been registered with the federation registry.",
        variant: "success",
      });
    }, 1500);
  };
    ...
    <div className="container mx-auto py-6 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className={isServerActive ? "border-green-500" : ""}>
          ...
          <CardContent>
            <div className="flex items-center gap-2">
              <div
                className={`h-3 w-3 rounded-full ${isServerActive ? "bg-green-500" : "bg-gray-300"}`}
              ></div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">
              {serverMetrics.averageResponseTime} ms
            </div>
            <p className="text-sm text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {[
                ...
                <Badge
                  key={capability}
                  variant={
                    serverConfig.capabilities.includes(capability)
                      ? "default"
                      : "outline"
                  }
                  ...
                  onClick={() => {
                    ...
                    setServerConfig((prev) => {
                      const capabilities = prev.capabilities.includes(
                        capability,
                      )
          ...
          <Alert>
            ...
            <AlertDescription>
              Changes to server configuration will only take effect after
          ...
          <Button
            ...
            onClick={() => {
              setServerConfig({
                name: "StockPulse MCP Server",
                description:
                  "Financial data and trading capabilities for AI agents",
                capabilities: [
                  "market_data",
                  "technical_analysis",
                  "portfolio_management",
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <Alert variant="warning">
            ...
            <AlertDescription>
              Exposing StockPulse as an MCP server makes its capabilities
              available to external clients. Ensure proper authentication and
              access controls are configured before activating the server.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
