...
const MCPSecurity: React.FC = () => {
  ...
  const runSecurityAudit = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description:
          "No vulnerabilities found. See recommendations for improvements.",
        variant: "success",
      });
  ...
  const toggleMutualTLS = () => {
    ...
    toast({
      title: tlsConfig.mutualTlsEnabled
        ? "Mutual TLS Disabled"
        : "Mutual TLS Enabled",
    ...
    <div className="container mx-auto py-6 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="flex items-center gap-2">
              <div
                className={`h-3 w-3 rounded-full ${tlsConfig.enabled ? "bg-green-500" : "bg-red-500"}`}
              ></div>
            ...
            <p className="text-sm text-muted-foreground">
              {tlsConfig.minVersion} with mutual TLS{" "}
              {tlsConfig.mutualTlsEnabled ? "enabled" : "disabled"}
            </p>
          </CardContent>
          <CardFooter>
        ...
        <Card>
          ...
          <CardFooter>
            <div className="text-sm text-muted-foreground">
              {permissionModels.reduce(
                (acc, model) => acc + model.permissions.length,
                0,
              )}{" "}
              total permissions
            </div>
        ...
        <Card>
          ...
          <CardFooter>
            <div className="text-sm text-muted-foreground">
              {rateLimiters.filter((limiter) => limiter.isThrottled).length}{" "}
              currently throttled
            </div>
          </CardFooter>
        </Card>
      ...
      <Tabs defaultValue={activeTab} onValueChange={setActiveTab}>
        <TabsList>
          ...
          <TabsTrigger value="connection-pooling">
            Connection Pooling
          </TabsTrigger>
        </TabsList>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    <div
                      className={`h-4 w-4 rounded-full ${securityAuditResults.status === "passed" ? "bg-green-500" : "bg-red-500"}`}
                    ></div>
                    <span className="font-medium text-lg">
                      {securityAuditResults.status === "passed"
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <Progress
                          ...
                          className="h-2"
                          indicatorClassName={
                            tlsConfig.mutualTlsEnabled
                              ? "bg-green-500"
                              : "bg-yellow-500"
                          }
                        />
                        <span className="text-sm">
                          {tlsConfig.mutualTlsEnabled ? "Strong" : "Good"}
                        </span>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {securityAuditResults.recommendations.map(
                  ...
                  {securityAuditResults.vulnerabilities.length > 0 ? (
                    <div className="mt-4">
                      ...
                      <div className="space-y-2">
                        {securityAuditResults.vulnerabilities.map(
                          (vulnerability, index) => (
                            <div key={index} className="flex items-start gap-2">
                              <AlertCircle
                                size={16}
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <div className="mt-4">
                    <div className="flex justify-between text-xs mb-1">
                      ...
                      <span>
                        {connectionPools.reduce(
                          (acc, pool) => acc + pool.activeConnections,
                          0,
                        )}
                      </span>
                    </div>
                    <Progress
                      value={
                        (connectionPools.reduce(
                          ...
                          connectionPools.reduce(
                            (acc, pool) => acc + pool.maxConnections,
                            0,
                          )) *
                        100
                      }
                    ...
                    <div className="flex justify-between text-xs mb-1">
                      ...
                      <span>
                        {connectionPools.reduce(
                          (acc, pool) => acc + pool.idleConnections,
                          0,
                        )}
                      </span>
                    </div>
                      ...
                      <div key={index} className="mb-2 last:mb-0">
                        <div className="flex justify-between text-xs mb-1">
                          <span className="truncate max-w-[150px]">
                            {limiter.serverUrl.replace("https://", "")}
                          </span>
                          <span>
                            {limiter.currentRequests}/
                            {limiter.maxRequestsPerMinute}
                          </span>
                        </div>
                        <Progress
                          value={
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setTlsConfig((prev) => ({
                          ...prev,
                          certificateRotationDays: parseInt(e.target.value),
                        }))
                      }
                    >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Require clients to present valid certificates for
                      authentication
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between mt-1">
                      ...
                      <input
                        ...
                        onChange={() =>
                          setTlsConfig((prev) => ({
                            ...prev,
                            ocspStaplingEnabled: !prev.ocspStaplingEnabled,
                          }))
                        }
                        className="h-4 w-4"
                      />
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Improve performance by including certificate validation
                      status
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-1">
                      <Badge
                        variant={
                          tlsConfig.preferredCipherSuites.includes(
                            "TLS_AES_256_GCM_SHA384",
                          )
                            ? "default"
                            : "outline"
              ...
              <Alert>
                ...
                <AlertDescription>
                  For maximum security, enable mutual TLS and use TLS 1.3 with
                  strong cipher suites. Rotate certificates every 90 days or
                  less.
                </AlertDescription>
              </Alert>
            </CardContent>
                              ...
                              setConnectionPools((prev) =>
                                prev.map((p) =>
                                  p.id === pool.id
                                    ? {
                                        ...p,
                                        maxConnections: p.maxConnections + 5,
                                      }
                                    : p,
                                ),
                              );
              ...
              <Button
                ...
                onClick={() => {
                  toast({
                    ...
                    description:
                      "Connection pools have been optimized for current load.",
                    variant: "success",
                  });
                }}
              >
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <Alert>
            ...
            <AlertDescription>
              Changes to security settings may require restarting MCP
              connections. Ensure all changes are properly tested before
          ...
          <Button
            ...
            onClick={() => {
              toast({
                ...
                description:
                  "Security and performance settings have been reset to defaults.",
                variant: "default",
              });
            }}
          >
          ...
          <Button
            onClick={() => {
              toast({
                ...
                description:
                  "Security and performance settings have been saved.",
                variant: "success",
              });
