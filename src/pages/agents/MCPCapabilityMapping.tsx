...
const MCPCapabilityMapping: React.FC = () => {
  ...
  const onNodeClick = (event, node) => {
    ...
    telemetry.addEvent(
      ...
      "mcp.capability_mapping.node_selected",
      {
        "mcp.node.id": node.id,
  ...
  const getNodeDetails = () => {
    ...
    switch (selectedNode.type) {
      case "server":
        ...
        const serverCapabilities = capabilities.filter((c) =>
          server.capabilityIds.includes(c.id),
        );
        const connectedClients = clients.filter((c) =>
          c.serverIds.includes(server.id),
        );
      ...
      case "client":
        ...
        const clientServers = servers.filter((s) =>
          client.serverIds.includes(s.id),
        );
      ...
      case "capability":
        ...
        const capabilityServer = servers.find(
          (s) => s.id === capability.serverId,
        );
        ...
        return (
          <div className="space-y-4">
            <div>
              ...
              <div className="text-sm mt-1">
                Type: <Badge variant="outline">{capability.type}</Badge>
              </div>
            </div>
                ...
                <div className="flex items-center gap-2 p-2 border rounded-md">
                  ...
                  <div>
                    <div className="text-sm font-medium">
                      {capabilityServer.name}
                    </div>
                    <div className="text-xs text-muted-foreground">
                      {capabilityServer.url}
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="space-y-2">
                ...
                <Select value={typeFilter} onValueChange={setTypeFilter}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="technical_analysis">
                      Technical Analysis
                    </SelectItem>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between text-sm text-muted-foreground">
                ...
                <span>
                  {capabilities.filter((c) => c.type === "market_data").length}
                </span>
              </div>
              <div className="flex items-center justify-between text-sm text-muted-foreground">
                ...
                <span>
                  {
                    capabilities.filter((c) => c.type === "technical_analysis")
                      .length
                  }
                </span>
              </div>
              <div className="flex items-center justify-between text-sm text-muted-foreground">
                ...
                <span>
                  {
                    capabilities.filter((c) => c.type === "sentiment_analysis")
                      .length
                  }
                </span>
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between text-sm text-muted-foreground">
                ...
                <span>
                  {edges.filter((e) => e.id.startsWith("client-")).length}
                </span>
              </div>
              <div className="flex items-center justify-between text-sm text-muted-foreground">
                <span>Server-Capability</span>
                <span>
                  {edges.filter((e) => e.id.startsWith("server-")).length}
                </span>
              </div>
            </div>
          </div>
