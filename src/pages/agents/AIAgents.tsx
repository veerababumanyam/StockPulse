        ...
        <TabsContent value="overview" className="mt-6 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Connect StockPulse to AI models and tools using the Model
                Context Protocol
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  ...
                  StockPulse can function as both an MCP client and server,
                  allowing seamless integration with AI capabilities.
                </AlertDescription>
              </Alert>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Connect to external MCP servers to enhance StockPulse with
                    additional AI capabilities, data sources, and tools.
                  </p>
                  <div className="flex gap-2">
                    <Button
                      variant="outline"
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Expose StockPulse capabilities as an MCP server, allowing
                    other applications to access financial data and trading
                    tools.
                  </p>
                  <div className="flex gap-2">
                    <Button
                    ...
                    <Button
                      ...
                      onClick={() => {
                        toast({
                          ...
                          description:
                            "StockPulse MCP Server is currently active and accessible.",
                          variant: "success",
                        });
                      }}
                    >
                  ...
                  <Button
                    ...
                    onClick={() => {
                      toast({
                        title: "Network Scan",
                        description:
                          "Scanning local network for MCP servers...",
                        variant: "default",
                      });
                      ...
                      setTimeout(() => {
                        toast({
                          title: "Scan Complete",
                          description:
                            "Found 1 MCP server on your local network.",
                          variant: "success",
                        });
                      }, 2000);
                    }}
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <div>
                ...
                <CardDescription>
                  Connect to AI models and tools using the Model Context
                  Protocol
                </CardDescription>
              </div>
              <div className="flex gap-2">
