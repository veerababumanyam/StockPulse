...
export interface DiversificationMetrics {
  ...
  geographicAllocation: Array<{ region: string; percentage: number; value: number }>;
  marketCapAllocation: Array<{ category: string; percentage: number; value: number }>;
...
export interface PositionAction {
  type: 'BUY_MORE' | 'SELL' | 'SET_ALERT' | 'VIEW_DETAILS' | 'VIEW_NEWS' | 'ANALYZE';
  symbol: string;
  data?: any;
}
