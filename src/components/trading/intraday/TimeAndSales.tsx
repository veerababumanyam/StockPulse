  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
      ...
      <div className="overflow-hidden">
        ...
        <div className="max-h-80 overflow-y-auto" style={{ scrollBehavior: 'smooth' }}>
            ...
            return (
              <motion.div 
                ...
                className={`grid grid-cols-12 text-sm py-1.5 ${
                  isLarge ? 'bg-yellow-50 dark:bg-yellow-900/20' : 
              ...
              >
                ...
                <div className={`col-span-2 ${isLarge ? 'font-bold' : 'font-medium'}`}>
                  {trade.size}
                </div>
      ...
      <div className="mt-4 flex justify-between items-center">
        <div className="flex space-x-4">
          <div className="flex items-center">
            ...
            />
            <label htmlFor="showConditions" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
              Show Conditions
            </label>
          </div>
          <div className="flex items-center">
            <input 
              ...
              className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
            />
            <label htmlFor="highlightLargeTrades" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
