...
const LevelTwoOrderBook: React.FC<LevelTwoOrderBookProps> = ({
  ...
  const spreadPercentage = asks.length && bids.length ? (spread / asks[0].price) * 100 : 0;
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div>
          ...
          <div className="bg-green-50 dark:bg-green-900/20 p-2 rounded-b-lg mt-1">
            <div className="flex justify-between text-xs">
              ...
              <span className="font-medium text-green-600 dark:text-green-400">{totalBidVolume.toLocaleString()}</span>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="bg-red-50 dark:bg-red-900/20 p-2 rounded-b-lg mt-1">
            <div className="flex justify-between text-xs">
              <span className="font-medium text-gray-700 dark:text-gray-300">Total Volume:</span>
              <span className="font-medium text-red-600 dark:text-red-400">{totalAskVolume.toLocaleString()}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 flex justify-between items-center">
        <div className="flex space-x-4">
          <div className="flex items-center">
            ...
            />
            <label htmlFor="showExchanges" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
              Show Exchanges
            </label>
          </div>
          <div className="flex items-center">
            <input 
              ...
              className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
            />
            <label htmlFor="autoRefresh" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
              Auto Refresh
            </label>
          </div>
        </div>
