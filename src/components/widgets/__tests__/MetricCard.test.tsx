...
describe("MetricCard", () => {
  ...
  it("applies default variant styles", () => {
    render(<MetricCard data-testid="metric-card">Test</MetricCard>);
  ...
  it("applies warning variant styles", () => {
    render(
      <MetricCard variant="warning" data-testid="warning-card">
        Test
      </MetricCard>,
    );
...
describe("MetricItem", () => {
  ...
  it("applies custom className", () => {
    const { container } = render(
      <MetricItem {...defaultProps} className="custom-class" />,
    );
