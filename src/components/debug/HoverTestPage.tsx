  ...
  return (
    <div className="min-h-screen bg-background-primary p-8 space-y-8">
      ...
      <div className="text-center">
        <h1 className="text-foreground text-3xl font-bold mb-4">🎯 Container Hover Effects Test</h1>
        <p className="text-muted-foreground">Hover over containers to see border highlight effects</p>
      </div>

      {/* Theme Switcher */}
      <div className="bg-elevated p-6 border border-surface rounded-lg space-y-4">
        <h2 className="text-foreground text-xl font-semibold">Quick Theme Switch</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-surface p-6 border border-surface rounded-lg shadow-md">
          <h3 className="text-foreground text-lg font-semibold mb-3">Surface Container</h3>
          <p className="text-muted-foreground text-sm">
            This container uses bg-surface and should highlight with primary border on hover.
          </p>
        ...
        <div className="bg-elevated p-6 border border-surface rounded-lg shadow-lg">
          <h3 className="text-foreground text-lg font-semibold mb-3">Elevated Container</h3>
          <p className="text-muted-foreground text-sm">
        ...
        <div className="bg-muted p-6 border border-surface rounded-lg shadow-md">
          <h3 className="text-foreground text-lg font-semibold mb-3">Muted Container</h3>
          <p className="text-muted-foreground text-sm">
        ...
        <div className="bg-surface p-6 border rounded-lg shadow-md">
          <h3 className="text-foreground text-lg font-semibold mb-3">Card Container</h3>
        ...
        <div className="bg-elevated p-6 border border-surface rounded-lg shadow-md cursor-pointer">
          <h3 className="text-foreground text-lg font-semibold mb-3">Interactive Container</h3>
        ...
        <div className="bg-surface p-6 border border-success/20 rounded-lg shadow-md">
          <h3 className="text-foreground text-lg font-semibold mb-3">Status Container</h3>
      ...
      <div className="bg-elevated p-6 border border-surface rounded-lg">
        <h3 className="text-foreground text-lg font-semibold mb-3">Hover Effects Guide</h3>
        <ul className="text-muted-foreground text-sm space-y-2">
          <li>• <strong>Border Highlight:</strong> Containers should show primary color border on hover</li>
          <li>• <strong>Shadow Enhancement:</strong> Box shadow should become more prominent</li>
          <li>• <strong>Subtle Transform:</strong> Some containers lift slightly (translateY(-1px))</li>
          <li>• <strong>Smooth Transitions:</strong> All effects should animate smoothly (200ms)</li>
          <li>• <strong>Theme Responsive:</strong> Border colors should match current color theme</li>
        </ul>
      </div>
