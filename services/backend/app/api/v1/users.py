...
async def get_user_watchlist(
    ...
    try:
        ...
        watchlist = (
            db.query(Watchlist)
            .filter(Watchlist.user_id == current_user.id, Watchlist.is_default == True)
            .first()
        )
        ...
        for item in watchlist_items:
            try:
                ...
                enhanced_item = {
                    ...
                    "logoUrl": market_data.get(
                        "logoUrl",
                        f"https://logo.clearbit.com/{item.symbol.lower()}.com",
                    ),
        ...
        response_data = {
            ...
            "lastUpdated": watchlist.updated_at.isoformat()
...
async def add_symbol_to_watchlist(
    ...
    try:
        ...
        new_item = WatchlistItem(
            watchlist_id=watchlist.id, symbol=symbol, company_name=company_name
        )
...
async def remove_symbol_from_watchlist(
    ...
    try:
        ...
        if not watchlist_item:
            return {"success": False, "message": f"{symbol} is not in your watchlist"}
        ...
        return {
            "success": True,
            "data": {"symbol": symbol, "watchlistId": str(watchlist.id)},
