...
test.describe("Complete Authentication Flows", () => {
  test.describe("Login Flow - Success Cases", () => {
    test("should successfully login with admin credentials", async ({
      ...
      await page
        ...
        .fill(TEST_CONFIG.credentials.admin.email);
      await page
        .getByLabel("Password")
        .fill(TEST_CONFIG.credentials.admin.password);
    ...
    test("should successfully login with user credentials", async ({
      ...
      await page
        .getByLabel("Email address")
        .fill(TEST_CONFIG.credentials.user.email);
      await page
        .getByLabel("Password")
        .fill(TEST_CONFIG.credentials.user.password);
  ...
  test.describe("Login Flow - Error Cases", () => {
    test("should show error for invalid credentials", async ({ page }) => {
      ...
      await page
        .getByLabel("Email address")
        .fill(TEST_CONFIG.credentials.invalid.email);
      await page
        .getByLabel("Password")
        .fill(TEST_CONFIG.credentials.invalid.password);
  ...
  test.describe("Accessibility", () => {
    ...
    test("should have proper ARIA labels", async ({ page }) => {
      ...
      ).toHaveAttribute("aria-label", "Sign in to your account");
    });
